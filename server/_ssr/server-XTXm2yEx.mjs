...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Cvwfhrp9.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BzXbVX-B.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BGy4afKD.mjs"),
		import("./start-zAZKKsws.mjs"),
