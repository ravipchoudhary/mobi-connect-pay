...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Cp_DLkv9.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D6nFYc2q.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BnKSPOTQ.mjs"),
		import("./start-CVmb1ZF0.mjs"),
