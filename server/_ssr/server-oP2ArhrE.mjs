...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CWVBaiMQ.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-OJ8iQSSm.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DBRef3hH.mjs"),
		import("./start-CMsF8GjC.mjs"),
