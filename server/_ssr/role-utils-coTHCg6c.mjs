import { a as findLocalUserById, o as getLocalSession } from "./local-store-CdTts1db.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/role-utils-coTHCg6c.js
var KNOWN_ROLES = [
	"super_admin",
	"master_distributor",
	"distributor",
