import { c as getLocalSession, s as findLocalUserById } from "./local-store-Z9jySGIS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/role-utils-BOS5-Wkq.js
var KNOWN_ROLES = [
	"super_admin",
	"master_distributor",
	"distributor",
