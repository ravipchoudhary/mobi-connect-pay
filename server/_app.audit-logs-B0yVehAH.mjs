...
var logs = [
	...
	},
	{
		id: 3,
		actor: "Retailer",
		action: "Processed recharge",
		timestamp: "2 hrs ago",
		target: "Airtel 9876543210"
	}
];
function AuditLogsPage() {
	const [query, setQuery] = (0, import_react.useState)("");
	const filtered = (0, import_react.useMemo)(() => logs.filter((item) => [
		item.actor,
		item.action,
		item.target
	].join(" ").toLowerCase().includes(query.toLowerCase())), [query]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
				...
				children: "Review the latest actions across your organization."
			})]
