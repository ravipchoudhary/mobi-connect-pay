...
import { n as useSession, t as signOut } from "./_ssr/use-session-BKfs5ahQ.mjs";
import { t as Skeleton } from "./_ssr/skeleton-D9W9wFsj.mjs";
import { _ as useNavigate, f as Outlet, g as Link, l as useRouterState } from "./_libs/@tanstack/react-router+[...].mjs";
import { D as Moon, E as PanelLeft, F as KeyRound, J as Circle, M as LifeBuoy, N as LayoutDashboard, P as Landmark, R as FingerprintPattern, S as Receipt, _ as Settings, _t as Activity, at as Check, b as ScrollText, ct as Bell, dt as BadgePercent, f as Sun, g as ShieldCheck, i as Users, k as LogOut, m as Smartphone, n as X, nt as ChevronRight, ot as ChartColumn, p as Sparkles, r as Wallet, s as UserCog, ut as Banknote, v as Send, y as Search } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app-CtNrdaIK.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "grid h-9 w-9 place-items-center rounded-xl bg-gradient-primary text-primary-foreground shadow-glow",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarContent, {
				className: "gap-1",
				children: groups.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: g.label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: g.items.map((item) => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 px-2 py-1.5 group-data-[collapsible=icon]:justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "grid h-9 w-9 place-items-center rounded-full bg-gradient-primary text-primary-foreground text-sm font-semibold",
						children: initial
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function AppLayout() {
	...
	if (!ready || !isAuthenticated) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarInset, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-border/60 bg-background/80 px-4 backdrop-blur-lg",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								className: "relative",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bell, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute right-2 top-2 h-2 w-2 rounded-full bg-destructive" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
								asChild: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									className: "ml-1 flex items-center gap-2 rounded-xl border border-border bg-card px-2 py-1.5 transition hover:bg-accent",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "grid h-7 w-7 place-items-center rounded-lg bg-gradient-primary text-xs font-semibold text-primary-foreground",
										children: initials
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: primaryRole?.replace("_", " ") ?? "user"
										})]
									})]
								})
